...
class Env:
    ...
    def __call__(self, var: str, cast=..., default=..., parse_default=...): ...
    def __contains__(self, var): ...
    def str(self, var: str, default: str = ..., multiline=...):  # -> str:
        """
        :rtype: str
        """
        ...
    def unicode(self, var: str, default=...):
        """Helper for python2
        :rtype: unicode
        """
        ...
    def bytes(self, var: str, default: bytes = ..., encoding=...):
        """
        :rtype: bytes
        """
        ...
    def bool(self, var: str, default: bool = ...):
        ...
        """
        ...
    def int(self, var: str, default: int = ...):
        """
        :rtype: int
        """
        ...
    def float(self, var: str, default: float = ...):
        """
        :rtype: float
        """
        ...
    def json(self, var: str, default=...):
        """
        :returns: Json parsed
        """
        ...
    def list(self, var: str, cast=..., default=...):
        """
        :rtype: list
        """
        ...
    def tuple(self, var: str, cast=..., default=...):
        """
        :rtype: tuple
        """
        ...
    def dict(self, var: str, cast=..., default=...):
        """
        :rtype: dict
        """
        ...
    def url(self, var: str, default=...):
        """
    ...
    def db_url(self, var=..., default=..., engine=...):
        ...
        ...
    db = ...
    def cache_url(self, var=..., default=..., backend=...):  # -> dict[str, Unknown]:
        ...
        ...
    cache = ...
    def email_url(self, var=..., default=..., backend=...):  # -> dict[Unknown, Unknown]:
        ...
        ...
    email = ...
    def search_url(self, var=..., default=..., engine=...):  # -> dict[Unknown, Unknown]:
        """Returns a config dictionary, defaulting to SEARCH_URL.

        :rtype: dict
        """
        ...
    def path(self, var: str, default=..., **kwargs):  # -> Path:
        """
        :rtype: Path
        """
        ...
    def get_value(self, var: str, cast=..., default=..., parse_default=...):
    ...
    def parse_value(
        cls, value, cast
    ):  # -> bool | list[Unknown] | tuple[Unknown, ...] | dict[Any, Any] | dict[Unknown, Unknown] | float:
    ...
    def db_url_config(cls, url, engine=...):
        ...
        * LDAP: ``ldap://``
        ...
        ...
    @classmethod
    def cache_url_config(cls, url, backend=...):  # -> dict[str, Unknown]:
    ...
    def search_url_config(cls, url, engine=...):  # -> dict[Unknown, Unknown]:
        ...
        ...
    @classmethod
    def read_env(cls, env_file=..., overwrite=..., **overrides):  # -> None:
...
class Path:
    ...
    def path(self, *paths, **kwargs):  # -> Self@Path:
